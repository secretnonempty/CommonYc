/*   1:    */ package com.rails.ecommerce.admin.api;
/*   2:    */ 
...
/*  17: 62 */   public static String SUBMIT_URL_CONFIRM = "https://dynamic.12306.cn/otsweb/order/confirmPassengerAction.do?method=confirmSingleForQueueOrder";
/*  18: 63 */   public static String QUERY_ORDER_URL = "https://dynamic.12306.cn/otsweb/order/myOrderAction.do?method=queryMyOrderNotComplete";
/*  19: 64 */   public static String QUERY_TRAIN_URL = "https://dynamic.12306.cn/otsweb/order/querySingleAction.do?";
/*  20: 65 */   public static String GET_TOKEN_URL = "https://dynamic.12306.cn/otsweb/order/querySingleAction.do?method=init";
/*  21: 67 */   public static String BUSS_SEAT = "9";
/*  22: 68 */   public static String BEST_SEAT = "p";
/*  23: 69 */   public static String ONE_SEAT = "M";
/*  24: 70 */   public static String TWO_SEAT = "O";
/*  25: 71 */   public static String VAG_SLEEPER = "6";
/*  26: 72 */   public static String SOFT_SLEEPER = "4";
/*  27: 73 */   public static String HARD_SLEEPER = "3";
/*  28: 74 */   public static String SOFT_SEAT = "2";
/*  29: 75 */   public static String HARD_SEAT = "1";
/*  30: 76 */   public static String NONE_SEAT = "-1";
/*  31: 78 */   public static String TRAIN_D = "D";
/*  32: 79 */   public static String TRAIN_G = "G";
/*  33: 80 */   public static String TRAIN_Z = "Z";
/*  34: 81 */   public static String TRAIN_K = "K";
/*  35: 82 */   public static String TRAIN_T = "T";
/*  36: 83 */   public static String TRAIN_L = "L";
/*  37: 85 */   public static boolean isLoginSuc = false;
/*  38:    */   public static String randCode;
/*  39:    */   public static String randstr;
/*  40: 99 */   public static byte isLockTrain = 0;
/*  41:100 */   public static byte isStrinStation = 1;
/*  42:101 */   public static byte isNeed_BEST_SEAT = 2;
/*  43:102 */   public static byte isNeed_BUSS_SEAT = 3;
/*  44:103 */   public static byte isNeed_HARD_SEAT = 4;
/*  45:104 */   public static byte isNeed_HARD_SLEEPER = 5;
/*  46:105 */   public static byte isNeed_NONE_SEAT = 6;
/*  47:106 */   public static byte isNeed_ONE_SEAT = 7;
/*  48:107 */   public static byte isNeed_VAG_SLEEPER = 8;
/*  49:108 */   public static byte isNeed_SOFT_SEAT = 9;
/*  50:109 */   public static byte isNeed_SOFT_SLEEPER = 10;
/*  51:110 */   public static byte isNeed_TWO_SEAT = 11;
/*  52:    */   public static final String USER_NOT_EXIST = "登录名不存在";
/*  53:    */   public static final String USER_PWD_ERR = "密码输入错误";
/*  54:    */   public static final String CODE_ERROR = "请输入正确的验证码";
/*  55:    */   public static final String USER_SUCC_INFO = "密码修改";
/*  56:    */   public static final String LOGIN_ERR_LOCKED = "已经被锁定";
/*  57:    */   public static final String LOGIN_ERR_INFO = "<title>登录</title>";
/*  58:    */   public static final String LOGIN_LOSTS_POEPLE = "当前访问用户过多";
/*  59:    */   public static final String LOGIN_SYS_MAINTAIN = "系统维护中";
/*  60:    */   public static final String UNKNOW_ERROR = "未知错误";
/*  61:    */   public static final String USER_RELOGIN = "当前访问用户过多,请重新登录";
/*  62:    */   public static final String USER_ERR = "帐号或密码错误";
/*  63:    */   public static final String LOGIN_SUC = "登录成功";
/*  64:127 */   private static Map<String, Integer> trainPriorityMap = new HashMap();
/*  65:128 */   private static Map<String, Integer> trainSeatMap = new HashMap();
/*  66:130 */   private static Map<String, String> trainSeatNameMap = new HashMap();
/*  67:131 */   public static Map<String, String> trainRang = new TreeMap();
/*  68:132 */   public static Map<String, String> cardType = new TreeMap();
/*  69:133 */   public static Map<String, String> ticketType = new TreeMap();
/*  70:134 */   public static Map<String, String> seatPos = new TreeMap();
/*  71:    */   
/*  72:    */   static
/*  73:    */   {
/*  74:136 */     trainPriorityMap.put(TRAIN_L, Integer.valueOf(40));
/*  75:137 */     trainPriorityMap.put(TRAIN_K, Integer.valueOf(50));
/*  76:138 */     trainPriorityMap.put(TRAIN_T, Integer.valueOf(60));
/*  77:139 */     trainPriorityMap.put(TRAIN_Z, Integer.valueOf(70));
/*  78:140 */     trainPriorityMap.put(TRAIN_D, Integer.valueOf(71));
/*  79:141 */     trainPriorityMap.put(TRAIN_G, Integer.valueOf(80));
/*  80:    */     
/*  81:143 */     trainSeatMap.put("有", Integer.valueOf(1000));
/*  82:144 */     trainSeatMap.put("无", Integer.valueOf(0));
/*  83:145 */     trainSeatMap.put("--", Integer.valueOf(-1));
/*  84:146 */     trainSeatMap.put("*", Integer.valueOf(-1));
/*  85:    */     
/*  86:148 */     trainSeatNameMap.put(BUSS_SEAT, "商务座");
/*  87:149 */     trainSeatNameMap.put(BEST_SEAT, "特等座");
/*  88:150 */     trainSeatNameMap.put(ONE_SEAT, "一等座");
/*  89:151 */     trainSeatNameMap.put(TWO_SEAT, "二等座");
/*  90:152 */     trainSeatNameMap.put(VAG_SLEEPER, "高级软卧");
/*  91:153 */     trainSeatNameMap.put(SOFT_SLEEPER, "软卧");
/*  92:154 */     trainSeatNameMap.put(HARD_SLEEPER, "硬卧");
/*  93:155 */     trainSeatNameMap.put(SOFT_SEAT, "软座");
/*  94:156 */     trainSeatNameMap.put(HARD_SEAT, "硬座");
/*  95:157 */     trainSeatNameMap.put(NONE_SEAT, "无座");
/*  96:    */     
/*  97:159 */     trainRang.put("全天", "00:00--24:00");
/*  98:160 */     trainRang.put("上午", "06:00--12:00");
/*  99:161 */     trainRang.put("下午", "12:00--18:00");
/* 100:162 */     trainRang.put("晚上", "18:00--24:00");
/* 101:163 */     trainRang.put("凌晨", "00:00--06:00");
/* 102:    */     
/* 103:165 */     cardType.put("二代身份证", "1");
/* 104:166 */     cardType.put("一代身份证", "2");
/* 105:167 */     cardType.put("港澳通行证", "C");
/* 106:168 */     cardType.put("台湾通行证", "G");
/* 107:169 */     cardType.put("护照", "B");
/* 108:    */     
/* 109:171 */     ticketType.put("成人票", "1");
/* 110:172 */     ticketType.put("儿童票", "2");
/* 111:173 */     ticketType.put("学生票", "3");
/* 112:174 */     ticketType.put("残军票", "4");
/* 113:    */     
/* 114:176 */     seatPos.put("默认", "0");
/* 115:177 */     seatPos.put("下铺", "1");
/* 116:178 */     seatPos.put("中铺", "2");
/* 117:179 */     seatPos.put("上铺", "3");
/* 118:    */   }
/* 119:    */   
/* 120:    */   public static String[] getRangTime()
/* 121:    */   {
/* 122:184 */     return new String[] { "全天", "上午", "下午", "晚上", "凌晨" };
/* 123:    */   }
/* 124:    */   
/* 125:    */   public static String[] getCardType()
/* 126:    */   {
/* 127:188 */     return new String[] { "二代身份证", "一代身份证", "港澳通行证", "台湾通行证", "护照" };
/* 128:    */   }
/* 129:    */   
/* 130:    */   public static String[] getTicketType()
/* 131:    */   {
/* 132:192 */     return new String[] { "成人票", "儿童票", "学生票", "残军票" };
/* 133:    */   }
/* 134:    */   
/* 135:    */   public static String[] getSeatPosType()
/* 136:    */   {
/* 137:196 */     return new String[] { "默认", "下铺", "中铺", "上铺" };
/* 138:    */   }
/* 139:    */   
/* 140:    */   public static Map<String, Integer> getTrainSeatMap()
/* 141:    */   {
/* 142:203 */     return trainSeatMap;
/* 143:    */   }
/* 144:    */   
/* 145:    */   public static void setTrainPriority(String key, int value)
/* 146:    */   {
/* 147:207 */     trainPriorityMap.put(key, Integer.valueOf(value));
/* 148:    */   }
/* 149:    */   
/* 150:    */   public static String getTrainSeatName(String key)
/* 151:    */   {
/* 152:211 */     return (String)trainSeatNameMap.get(key);
/* 153:    */   }
/* 154:    */   
/* 155:    */   public static String getTrainRang(String key)
/* 156:    */   {
/* 157:215 */     return (String)trainRang.get(key);
/* 158:    */   }
/* 159:    */ }


/* Location:           C:\Users\Administrator\Desktop\GoHome_2013版\original-ticketRobot-0.0.1-SNAPSHOT.jar
 * Qualified Name:     com.ywh.train.Constants
